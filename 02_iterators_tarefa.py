...
def main():
    ...
    iterador_dias = iter(dias)  # iterador é como um index
    print(next(iterador_dias))  # next, traz o próximo valor
    print(next(iterador_dias))
    print(next(iterador_dias))

    # TODO: Use uma função para iterar sobre um arquivo
    # with open("C:\\Users\\neto_\\Desktop\\NETO PANIGASSI\\Cursos (Estudos em casa)\\Python\\Curso 2\\arquivos_de_exercicios_python_avancado\\Cap. 2 - Funções embutidas\dados.txt", "r") as fp:
